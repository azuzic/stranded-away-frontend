                    ...
                    <v-row class="pr-4">
                        ...
                        <v-col cols="12" class="ml-4 text-2xl text-red-like-logo">
                            ...
                            <v-row class="mr-2 justify-left w-full">
                                <v-col v-for="gameCard in isPlayed(store.gameCards)" :key="gameCard.id" :cols="width">
                                    <gameCard :availability="''" :title="gameCard.title"
                                        :text="gameCard.text" :imageSrc="gameCard.imageSrc" :gName="gameCard.gameName">
                                    </gameCard>
                                </v-col>
                            </v-row>
                        </v-col>
                        ...
                        <v-row class="ml-4 text-2xl text-red-like-logo">
                            ...
                            <v-col class="col-12" v-for="(game, id) in user.profile.games" :key="id">
                                ...
                                <v-col class="flex flex-wrap align-center min-w-200px justify-start">
                                    <v-tooltip color="#EF5350" top v-for="(trophies, id2) in game.trophies" :key="id2">
                                        <template v-slot:activator="{ on, attrs }">
                                            ...
                                            " v-bind="attrs" v-on="on" class="trophy m-4" :src="
                                              trophies.unlocked
                            ...
                            <v-overlay @click="overlay = !overlay" :value="overlay">
                                <div class="bg-transparent-90 p-8 rounded-xl">
                                    <img class="trophyOverlay m-4" :src="
                                      trophieLocked
