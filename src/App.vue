                ...
                <v-app-bar class="v-app-bar navbarColor" fixed>
                    <v-row justify="start" align="start">
                        <v-col align-self="center" :cols="$vuetify.breakpoint.mobile ? '12' : '2'">
                            <router-link to="/">
                                <img class="p-4" src="@/assets/macroquiet_logo.png" alt="" :width="logoWidth" />
                            </router-link>
                        </v-col>
                        <!--LINKS-->
                        <v-col v-show="!$vuetify.breakpoint.mobile" align-self="center" cols="9" class="mt-2">
                            <v-btn v-for="link in links" :key="link.title" color="white" text rounded class="my-4"
                                cols="2" @click="scroll(link.to)">
                        ...
                        <v-col cols="1" align-self="center" v-show="!$vuetify.breakpoint.mobile">
                            <v-btn v-if="!auth.authenticated" color="secondary" rounded class="my-4"
                                        ...
                                        <v-list-item-content class="justify-center">
                                            <div class="mx-auto text-center">
                                                <v-avatar color="gray " size="48">
                                                    ...
                                                    <v-skeleton-loader v-else light type="avatar" height="48px">
                                                    </v-skeleton-loader>
                                                </v-avatar>
                                                <h3>{{ user.username }}</h3>
                    ...
                    <v-app-bar-nav-icon color="white" v-show="$vuetify.breakpoint.mobile"
                ...
                <v-navigation-drawer v-model="drawer" absolute temporary height="auto" color="grey darken-4 h-100">
                    <v-list dense>
                        ...
                        <v-list-item class="justify-center white--text">
                            <v-btn v-if="!auth.authenticated" color="secondary" rounded class="my-4" cols="2"
            ...
            <v-footer :padless="padless" bottom fixed>
                <v-card flat tile width="100%" class="navbarColor text-center">
                    <v-card-text class="white--text flex justify-center align-center mb-0">
                        <span class="-mb-4"><strong>MacroQuiet Game Development <br /></strong>
